...
const DepositCash = () => {
    ...
    useEffect(()=>{
        axios.get(`https://www.truewayagentbackend.com/getCashPayment?LocationId=${LocationId}`)
    ...
    useEffect(()=>{
        console.log(`$1: ${box.pay1}, $5: ${box.pay5}, $10: ${box.pay10}, $20: ${box.pay20}, $50: ${box.pay50}, $100: ${box.pay100}. ${box.note} `)
    },[box])
    useEffect(()=>{
        let amount = 0  
    ...
    const submit = () =>{
        ...
        onOpenModal()
        fetch(`https://www.truewayagentbackend.com/deposit`, {
