...
function DailyReport() {
    ...
    useEffect(() => {
        axios.get(`https://www.truewayagentbackend.com/dailyReport?LocationId=${LocationId}`)
    ...
    useEffect(() => {
        axios.get(`https://www.truewayagentbackend.com/dailyReport?LocationId=${LocationId}&yesterday=true`)
        .then(function(response){
    ...
    let onSubmit = ()=>{
        ...
        fetch(`https://www.truewayagentbackend.com/addDailyReport`, {
