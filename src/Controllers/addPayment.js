...
function AddPayment(props) {
  ...
  useEffect(() => {
    axios
      .get(`https://www.truewayagentbackend.com/clientQuotes?client=${form.id}`)
...
const handleNewClient = () => {
  ...
  const onSubmit = (data) => {
    ...
    if(!MultiMethod){
      if (newClient == false) {
        fetch(`https://www.truewayagentbackend.com/addPayment`, {
          method: "POST",
          headers: {
        ...
        fetch(`https://www.truewayagentbackend.com/addClientPayment`, {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
          },
    ...
    if (newClient == false) {
      fetch(`https://www.truewayagentbackend.com/addMultiPayment`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
      ...
      fetch(`https://www.truewayagentbackend.com/ClientMultiPayment`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
