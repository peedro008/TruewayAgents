...
const Management=()=>{
    ...
    return( <div  className="genericDiv">
        ...
        <div className="managerContainer">
            ...
            <NavLink to={"./management/Company"}  style={{ textDecoration: 'none', color:"#000" }}>
            ...
            <NavLink to={"./management/Producer"}  style={{ textDecoration: 'none', color:"#000" }}>
            ...
            <NavLink to={"./management/Manager"}  style={{ textDecoration: 'none', color:"#000" }}>
        ...
        <div className="managerContainer1">
            <NavLink to={"./management/Location"}  style={{ textDecoration: 'none', color:"#000" }}>
            ...
            <NavLink to={"./management/DealerSalePerson"}  style={{ textDecoration: 'none', color:"#000" }}>
            ...
            <NavLink to={"./management/Category"}  style={{ textDecoration: 'none', color:"#000" }}>
        ...
        <div className="managerContainer1">
             <NavLink to={"./management/Client"}  style={{ textDecoration: 'none', color:"#000" }}>
            ...
            <NavLink to={"./management/Dealer"}  style={{ textDecoration: 'none', color:"#000" }}>
